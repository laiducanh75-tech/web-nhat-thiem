...
export default function LogisticsPage() {
  ...
  return (
    <main className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-[#002b5b] text-white shadow-xl">
        <div className="container mx-auto px-4 h-20 md:h-24 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={myImg} alt="Logo" className="h-10 md:h-14 w-auto bg-white p-1 rounded shadow-md" />
            <div>
          ...
          <nav className="hidden lg:flex items-center space-x-5 font-bold text-xs uppercase">
            ...
            <a href="#bao-gia" className="bg-[#f05a28] px-5 py-3 rounded-lg hover:bg-[#d44d1f] transition-all shadow-lg active:scale-95">NHẬN BÁO GIÁ</a>
          </nav>
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden bg-[#001f42] p-5 flex flex-col gap-4 border-t border-white/10 animate-in slide-in-from-top">
      ...
      {/* 3. HERO SECTION - TỐI ƯU CHỮ CHO MOBILE */}
      <section className="bg-[#002b5b] py-12 md:py-24 text-white border-b-4 border-orange-500">
        <div className="container mx-auto px-4 text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1 w-full">
              <h1 className="text-3xl md:text-6xl font-black mb-4 leading-tight uppercase italic tracking-tight">
                Giải pháp Logistics <br className="hidden md:block"/><span className="text-orange-500">Thông minh</span>
              </h1>
              <p className="text-sm md:text-xl font-bold mb-8 text-green-400 uppercase tracking-widest italic">
              ...
              <div className="bg-[#f05a28] p-0.5 rounded-2xl shadow-xl max-w-lg mx-auto md:mx-0 overflow-hidden">
                <div className="bg-[#002b5b] p-5 md:p-6 rounded-[14px]">
            ...
            <div className="flex-1 w-full max-w-xs md:max-w-md">
               <img src={myImg} alt="Banner" className="w-full rounded-[2rem] shadow-2xl border-4 border-white/10" />
            </div>
          </div>
        </div>
      </section>

      {/* 4. DỊCH VỤ - GRID PHẢN HỒI */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className={`bg-white p-8 rounded-3xl shadow-md border-b-8 ${s.color} text-center`}>
      ...
      {/* 6. FORM BÁO GIÁ */}
      <section id="bao-gia" className="py-16 bg-slate-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase italic tracking-tighter text-orange-500">Báo giá ngay</h2>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl text-slate-900">
              <div className="space-y-3">
                <input type="text" placeholder="Họ và tên *" className="w-full p-3.5 bg-slate-100 rounded-xl outline-none font-bold text-sm border-2 border-transparent focus:border-orange-500" />
                <input type="tel" placeholder="Điện thoại *" className="w-full p-3.5 bg-slate-100 rounded-xl outline-none font-bold text-sm border-2 border-transparent focus:border-orange-500" />
                <textarea placeholder="Nội dung cần báo giá..." className="w-full p-3.5 bg-slate-100 rounded-xl outline-none font-bold text-sm h-24 focus:border-orange-500"></textarea>
                <button className="w-full bg-[#f05a28] text-white py-4 rounded-xl font-black text-lg shadow-lg hover:bg-orange-600 uppercase active:scale-95 transition-all">Gửi yêu cầu</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-[#001f42] text-white py-12 text-center border-t border-white/5">
        <div className="container mx-auto px-4">
          <img src={myImg} alt="Footer Logo" className="h-14 w-auto mx-auto bg-white p-2 rounded-xl mb-6 shadow-md" />
          <h4 className="text-sm font-black uppercase mb-4 tracking-tight">NHẤT THIÊN SƠN SÀI GÒN LOGISTICS</h4>
