...
export default function LogisticsPage() {
  ...
  return (
    <main className="min-h-screen bg-white font-sans text-slate-900">
      ...
      {/* 1. TOP BAR - Đầy đủ Hotline & Email */}
      <div className="bg-[#001f42] text-white py-2.5 text-xs border-b border-white/10">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex gap-6">
            ...
            <span className="flex items-center gap-1.5 hidden md:flex"><Phone size={14} className="text-orange-400"/> 0919 417 239</span>
            <span className="flex items-center gap-1.5 hidden lg:flex"><Mail size={14} className="text-orange-400"/> nhatthiensonsaigon@gmail.com</span>
          </div>
          <div className="font-semibold uppercase tracking-wider hidden sm:block">Thứ 2 - Thứ 7: 08:00 - 18:00</div>
        </div>
      </div>

      {/* 2. HEADER - Logo chuẩn & Menu đầy đủ */}
      <header className="sticky top-0 z-50 bg-[#002b5b] text-white shadow-2xl">
        <div className="container mx-auto px-4 h-24 flex items-center justify-between">
          ...
          <button className="lg:hidden p-2" onClick={() => setIsOpen(!isOpen)}>{isOpen ? <X size={32}/> : <Menu size={32}/>}</button>
        </div>
        ...
        {isOpen && (
          <div className="lg:hidden bg-[#001f42] p-6 flex flex-col gap-4 border-t border-white/10">
            ...
            <a href="#" className="font-bold border-b border-white/5 pb-2">Theo dõi</a>
      ...
      <section className="relative h-[700px] flex items-center text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-5xl md:text-8xl font-black mb-6 leading-[1] tracking-tighter">Giải pháp Logistics <br/><span className="text-white">Thông minh</span></h1>
      ...
      {/* 4. DỊCH VỤ CHI TIẾT - 4 Cột */}
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-black text-[#002b5b] uppercase tracking-tighter mb-4">Dịch vụ <span className="text-orange-500">toàn diện</span></h2>
            <p className="text-slate-500 font-bold text-lg">Uy tín tạo nên thương hiệu Nhất Thiên Sơn</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className={`bg-white p-10 rounded-[40px] shadow-xl hover:-translate-y-3 transition-all border-b-[12px] ${s.color} group`}>
                ...
                <h3 className="text-xl font-bold mb-4 text-[#002b5b]">{s.title}</h3>
                <p className="text-slate-500 font-semibold text-sm leading-relaxed">Giải pháp tối ưu nhất cho lô hàng của bạn, đảm bảo tiến độ và an toàn 100%.</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-10 bg-slate-50 rounded-[3rem] hover:bg-[#002b5b] hover:text-white transition-all group">
                ...
                <p className="text-sm font-bold opacity-60">Chuyên nghiệp - Minh bạch</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* 6. FORM BÁO GIÁ & THÔNG TIN LIÊN HỆ */}
        ...
        <div className="container mx-auto px-4 max-w-6xl relative">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl text-slate-900">
              <h3 className="text-3xl font-black mb-8 uppercase text-[#002b5b] text-center italic">Gửi yêu cầu ngay</h3>
              <div className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                   <input type="text" placeholder="Họ và tên *" className="w-full p-5 bg-slate-100 rounded-2xl outline-none border-2 border-transparent focus:border-orange-500 font-bold" />
                   <input type="tel" placeholder="Điện thoại *" className="w-full p-5 bg-slate-100 rounded-2xl outline-none border-2 border-transparent focus:border-orange-500 font-bold" />
                </div>
                <input type="email" placeholder="Địa chỉ Email" className="w-full p-5 bg-slate-100 rounded-2xl outline-none border-2 border-transparent focus:border-orange-500 font-bold" />
                <textarea placeholder="Thông tin hàng hóa, quy cách, điểm đi - điểm đến..." className="w-full p-5 bg-slate-100 rounded-2xl outline-none border-2 border-transparent focus:border-orange-500 font-bold h-36"></textarea>
      ...
      <footer className="bg-[#001f42] text-white py-16 border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          <img src="https://i.ibb.co/Xz900jC/logo-ts-red.png" alt="Footer Logo" className="h-20 w-auto mx-auto bg-white p-3 rounded-2xl mb-8 shadow-2xl" />
          <h4 className="text-3xl font-black uppercase mb-4 tracking-tighter">Nhất Thiên Sơn Sài Gòn Logistics</h4>
          <p className="text-white/50 font-bold max-w-2xl mx-auto mb-12 uppercase tracking-widest text-sm">Đối tác vận tải chiến lược - Vươn tầm cùng doanh nghiệp</p>
          <div className="flex justify-center gap-10 text-orange-400 font-black mb-12">
             <span className="flex items-center gap-2 tracking-tighter"><Globe size={18}/> TOÀN CẦU</span>
             <span className="flex items-center gap-2 tracking-tighter"><Truck size={18}/> NỘI ĐỊA</span>
